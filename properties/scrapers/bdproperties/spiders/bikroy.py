...
class BikroySpider(scrapy.Spider):
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        ...
        """
        spider = super(BikroySpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def spider_opened(self):
        ...
        self.platform=Platfroms.objects.create(name="bikroy")
    ...
    def parse_details_page(self, response):
        ...
        property = Property(
            ...
            commercial_type=item.get('commercial_type', False),
            property_url=item.get('property_url', ''),
            property_description=item.get('property_description', ''),
            property_overview='',  # not provided in the original item
            price=item.get('price', ''),
            location=item.get('location', ''),
            num_bed_rooms=item.get('num_bed_rooms', ''),
            num_bath_rooms=item.get('num_bath_rooms', ''),
            area=item.get('area', ''),
            building_type=item.get('building_type', ''),
            purpose='',  # not provided in the original item
            amenities=''  # not provided in the original item
        )
